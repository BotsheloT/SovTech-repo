    ...
    <div className={darkMode ? "dark" : "" }>
        ...
        <section className='min-h-screen px-10'>
          ...
          <nav className='pt-4 mb-3 flex justify-between'>
            ...
            <ul className='flex items-center'>
              <li> <BsFillMoonFill className='cursor-pointer text-2xl' onClick={() => setDarkMode(!darkMode)}/> </li>
      ...
      <section className='px-10'>
        ...
        <div className='text-center py-10'>
          ...
          <div className='w-auto h-auto bg-gray-100 rounded-lg bg-center text-center my-10'>
